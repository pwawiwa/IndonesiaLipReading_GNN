"""
Hybrid Adaptive GCN-LSTM-Mamba model: Adaptive GCN for spatial, LSTM for short-term temporal, Mamba for long-range temporal.
Sequential architecture: Adaptive GCN → LSTM → Mamba → Classifier
"""
import torch
...
class AdaptiveGCNLSTMMambaModel(BaseGNNModel):
    """
    Hybrid Adaptive GCN-LSTM-Mamba model: Adaptive GCN for spatial, LSTM for short-term temporal, Mamba for long-range temporal.
    
    Architecture: Adaptive GCN (spatial) → LSTM (short-term) → Mamba (long-range) → Classifier
    
    Combines:
    - Adaptive GCN: Learns task-specific graph structure
    - LSTM: Captures short-term temporal patterns
    - Mamba: Captures long-range co-articulation dependencies
    """
    ...
    def __init__(
        ...
        """
        Initialize Adaptive GCN-LSTM-Mamba model.
        ...
        Args:
            ...
            alpha: Weight for combining fixed and adaptive adjacency
