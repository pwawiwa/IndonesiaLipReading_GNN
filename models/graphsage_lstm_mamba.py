"""
Hybrid GraphSAGE-LSTM-Mamba model: GraphSAGE for spatial, LSTM for short-term temporal, Mamba for long-range temporal.
Sequential architecture: GraphSAGE → LSTM → Mamba → Classifier
"""
import torch
...
class GraphSAGELSTMMambaModel(BaseGNNModel):
    """
    Hybrid GraphSAGE-LSTM-Mamba model: GraphSAGE for spatial, LSTM for short-term temporal, Mamba for long-range temporal.
    
    Architecture: GraphSAGE (spatial) → LSTM (short-term) → Mamba (long-range) → Classifier
    """
    ...
    def __init__(
        ...
        """
        Initialize GraphSAGE-LSTM-Mamba model.
