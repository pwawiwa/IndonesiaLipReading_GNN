"""
Hybrid GNN-LSTM and GNN-GRU models.
"""
import torch
...
class GNNLSTMModel(BaseGNNModel):
    """Hybrid GNN-LSTM model: GNN for spatial, LSTM for temporal."""
...
class GNNGRUModel(BaseGNNModel):
    """Hybrid GNN-GRU model: GNN for spatial, GRU for temporal."""
